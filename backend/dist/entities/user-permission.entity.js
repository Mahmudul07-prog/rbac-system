...
__decorate([
    (0, typeorm_1.ManyToOne)(() => permission_entity_1.Permission, (p) => p.userPermissions, { onDelete: 'CASCADE' }),
...
], UserPermission.prototype, "granted", void 0);
__decorate([
...
exports.UserPermission = UserPermission = __decorate([
    ...
    (0, typeorm_1.Unique)(['userId', 'permissionId'])
], UserPermission);
